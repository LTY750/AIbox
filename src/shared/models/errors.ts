...
export class ChatboxAIAPIError extends BaseError {
  static codeNameMap: { [codename: string]: ChatboxAIAPIErrorDetail } = {
    ...
    textin_credentials_required: {
      name: 'textin_credentials_required',
      code: 20044,
      i18nKey:
        'TextIn App ID and Secret Code are required. Please go to <OpenDocumentParserSettingButton>Settings</OpenDocumentParserSettingButton> and configure your TextIn credentials.',
    },
