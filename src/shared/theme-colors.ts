...
export type InterfaceFontFamily = 'system' | 'claude' | 'serif' | 'mono'

export const DEFAULT_INTERFACE_FONT_FAMILY: InterfaceFontFamily = 'system'

export const INTERFACE_FONT_FAMILY_OPTIONS = [
  { value: 'system', label: 'System' },
  { value: 'claude', label: 'Claude' },
  { value: 'serif', label: 'Serif' },
  { value: 'mono', label: 'Monospace' },
] as const satisfies ReadonlyArray<{ value: InterfaceFontFamily; label: string }>

export const INTERFACE_FONT_FAMILY_CSS: Record<InterfaceFontFamily, string> = {
  system:
    '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Oxygen, Ubuntu, Cantarell, "Fira Sans", "Droid Sans", "Helvetica Neue", sans-serif',
  claude:
    '"Lora Variable", Lora, "Source Serif Pro", "Source Serif 4", "Noto Serif SC", "Noto Serif TC", "Noto Serif JP", "Noto Serif KR", "Source Han Serif SC", "Source Han Serif TC", "Source Han Serif", "Songti SC", STSong, "STSongti-SC-Regular", "PingFang SC", SimSun, NSimSun, "宋体", FangSong, "仿宋", KaiTi, "楷体", Georgia, "Times New Roman", Cambria, "Liberation Serif", serif',
