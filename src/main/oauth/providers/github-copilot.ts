...
export const githubCopilotOAuthProvider: DeviceCodeOAuthProvider = {
  ...
  // The provider contract is promise-based even though this token type has no refresh step.
  // biome-ignore lint/suspicious/useAwait: OAuth providers intentionally share async methods.
