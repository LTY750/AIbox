 ...
 *
 * The provider stays as an explicit extension point for a future remote
 * sandbox API. It must never be selected on mobile until every operation has
 * a real authenticated backend implementation.
 */
