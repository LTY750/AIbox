...
import { mergeFetchedImageModels } from '@/packages/image-model-catalog'
    ...
    try {
      ...
      if (modelList.length) {
        if (baseInfo.isCustom) {
          const modelsWithFetchedImages = mergeFetchedImageModels(displayModels, modelList)
          if (modelsWithFetchedImages !== displayModels) {
            setProviderSettings({ models: modelsWithFetchedImages })
          }
        }
