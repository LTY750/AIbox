import type { capSQLiteSet, SQLiteDBConnection } from '@capacitor-community/sqlite'
...
import { getSharedSQLiteDatabase } from './sqliteConnection'
...
export class SQLiteSessionMetaStorage implements SessionMetaStorage {
  ...
  private async openDatabase(): Promise<void> {
    // Schema (session_meta table) is created by the versioned migration runner
    // invoked from getSharedSQLiteDatabase.
    this.database = await getSharedSQLiteDatabase(DB_NAME, 2)
  }
