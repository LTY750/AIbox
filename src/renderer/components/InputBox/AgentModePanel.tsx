...
const AgentModePanel: FC<AgentModePanelProps> = ({
  ...
  // --- Mode button ---
  // biome-ignore lint/nursery/noNestedComponentDefinitions: These controls intentionally capture panel state.
  ...
  // --- Extension row ---
  // biome-ignore lint/nursery/noNestedComponentDefinitions: This row intentionally captures panel interaction handlers.
  ...
  // --- Sub-panel header ---
  // biome-ignore lint/nursery/noNestedComponentDefinitions: This header intentionally captures panel navigation handlers.
