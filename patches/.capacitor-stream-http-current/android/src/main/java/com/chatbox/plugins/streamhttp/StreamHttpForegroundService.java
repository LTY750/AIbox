...
public final class StreamHttpForegroundService extends Service {
    ...
    /**
     * Stream completion happens on worker threads. Keep foreground-service
     * transitions on the main looper so a completion cannot race a new start.
     */
    private void requestRefresh() {
        handler.post(this::refreshForegroundState);
    }
